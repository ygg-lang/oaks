...
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for VomlLanguageService<V> {
    type Lang = VomlLanguage;
    type Vfs = V;
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::VomlParser::new(&language);
            let lexer = crate::lexer::VomlLexer::new(&language);

...
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for GroovyLanguageService<V> {
    type Lang = GroovyLanguage;
    type Vfs = V;
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::GroovyParser::new(&language);
            let lexer = crate::lexer::GroovyLexer::new(&language);

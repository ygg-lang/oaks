...
use crate::language::ElmLanguage;
...
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for ElmLanguageService<V> {
    type Lang = ElmLanguage;
    type Vfs = V;
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::ElmParser::new(&language);
            let lexer = crate::lexer::ElmLexer::new(&language);

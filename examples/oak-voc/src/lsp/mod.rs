...
#[cfg(feature = "lsp")]
/// Voc language service implementation.
pub struct VocLanguageService<V: Vfs> {
    vfs: V,
    workspace: oak_lsp::workspace::WorkspaceManager,
}
#[cfg(feature = "lsp")]
impl<V: Vfs> VocLanguageService<V> {
    /// Creates a new `VocLanguageService`.
...
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for VocLanguageService<V> {
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::VocParser::new(&language);
            let lexer = crate::lexer::VocLexer::new(&language);

...
pub fn to_value<T: serde::Serialize>(value: &T) -> Result<JsonValue, Error> {
    value.serialize(Serializer)
}

/// Converts a `JsonValue` to a deserializable value of type `T`.
pub fn from_value<T: serde::de::DeserializeOwned>(value: JsonValue) -> Result<T, Error> {
    T::deserialize(value)
}
...
impl<'de> serde::de::Deserializer<'de> for JsonValue {
    type Error = Error;

...
[![Crates.io](https://img.shields.io/crates/v/oak-mojo.svg)](https://crates.io/crates/oak-mojo)
[![Documentation](https://docs.rs/oak-mojo/badge.svg)](https://docs.rs/oak-mojo)

**Making MOJO processing simple** — A high-performance, incremental MOJO parser built on the Oak framework.

## 🎯 Project Vision

`oak-mojo` is dedicated to providing industrial-grade parsing support for the MOJO language. By leveraging Rust's high-performance characteristics and Oak's incremental parsing architecture, it can easily handle a variety of application scenarios, from simple script analysis to complex IDE language servers.

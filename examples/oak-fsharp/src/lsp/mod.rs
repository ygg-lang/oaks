...
use crate::language::FSharpLanguage;
...
#[cfg(feature = "lsp")]
/// F# language service
pub struct FsharpLanguageService<V: Vfs> {
    vfs: V,
    workspace: oak_lsp::workspace::WorkspaceManager,
}
impl<V: Vfs> FsharpLanguageService<V> {
    /// Creates a new FsharpLanguageService
    pub fn new(vfs: V) -> Self {
        Self { vfs, workspace: oak_lsp::workspace::WorkspaceManager::new() }
    }
}
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for FsharpLanguageService<V> {
    type Lang = FSharpLanguage;
    type Vfs = V;
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::FSharpParser::new(&language);
            let lexer = crate::lexer::FSharpLexer::new(&language);

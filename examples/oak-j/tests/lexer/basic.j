-- Comprehensive J test file for lexer testing

-- Single-line comment

-- Multi-line comments are not standard in J, but block comments can be simulated
-- by multiple single-line comments or by using pragmas for documentation.

with J.Text_IO;
with J.Integer_Text_IO;
with J.Float_Text_IO;
use J.Text_IO;

procedure J_Features_Test is
   ...
   Greeting       : constant String := "Hello, J!";
...
begin -- J_Features_Test
   Display_Message ("Starting J Features Test...");

   -- Test basic types and variables
   J.Integer_Text_IO.Put (Decimal_Int);
   Put_Line ("");
   J.Float_Text_IO.Put (Real_Literal);
   Put_Line ("");
   ...
   Display_Message ("J Features Test Finished.");

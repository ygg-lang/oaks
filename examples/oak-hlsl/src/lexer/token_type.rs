...
/// Token types for the HLSL (High-Level Shading Language) lexer.
///
/// This enum represents all possible token types in HLSL,
/// including data types, texture types, control flow keywords, operators, and punctuation.

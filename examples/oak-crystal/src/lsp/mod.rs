...
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for CrystalLanguageService<V> {
    type Lang = CrystalLanguage;
    type Vfs = V;
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::CrystalParser::new(&language);
            let lexer = crate::lexer::CrystalLexer::new(&language);

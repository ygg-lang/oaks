...
use crate::language::DockerfileLanguage;
...
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for DockerfileLanguageService<V> {
    type Lang = DockerfileLanguage;
    type Vfs = V;
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::DockerfileParser::new(&language);
            let lexer = crate::lexer::DockerfileLexer::new(&language);

...
pub type DejavuTokenType = DejavuSyntaxKind;

impl TokenType for DejavuSyntaxKind {
    ...
    fn role(&self) -> Self::Role {
        match self {
            ...
            Self::Keyword(DejavuKeywords::Is) | Self::Keyword(DejavuKeywords::In) => UniversalTokenRole::Operator,

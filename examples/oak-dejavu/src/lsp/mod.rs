...
#[cfg(feature = "lsp")]
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for DejavuLanguageService<V> {
    type Lang = DejavuLanguage;
    type Vfs = V;
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::DejavuParser::new(&language);
            let lexer = crate::lexer::DejavuLexer::new(&language);

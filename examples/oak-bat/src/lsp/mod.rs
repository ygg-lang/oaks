...
#[cfg(feature = "lsp")]
pub struct BatLanguageService<V: Vfs> {
    vfs: V,
    workspace: oak_lsp::workspace::WorkspaceManager,
}

#[cfg(feature = "lsp")]
impl<V: Vfs> BatLanguageService<V> {
...
#[cfg(feature = "lsp")]
impl<V: Vfs + Send + Sync + 'static + oak_vfs::WritableVfs> LanguageService for BatLanguageService<V> {
    type Lang = BatLanguage;
    type Vfs = V;
        ...
        F: FnOnce(RedNode<'_, Self::Lang>) -> R + Send,
    {
        ...
        async move {
            ...
            let parser = crate::parser::BatParser::new(&language);
            let lexer = crate::lexer::BatLexer::new(&language);
